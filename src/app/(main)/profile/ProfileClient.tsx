      ...
      <div className="flex items-center gap-1 overflow-x-auto scrollbar-hide">
        {tabs.map((tab) => (
          <button
            ...
            className={[
              "flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-all duration-200 cursor-pointer",
              activeTab === tab.key
                ? "border-2 border-[var(--color-primary)] text-[var(--color-primary)]"
                : "border-2 border-transparent text-white/70 hover:text-white hover:bg-white/5",
            ].join(" ")}
          >
            {tab.icon}
            {tab.label}
